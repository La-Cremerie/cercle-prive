...
import { 
  ...
  Calendar, MessageSquare, TrendingUp, Eye, Globe, Shield
} from 'lucide-react';
...
const AdminPanel: React.FC<AdminPanelProps> = ({ onLogout }) => {
  ...
  const tabs = [
    ...
    { key: 'properties', label: 'Biens', icon: Shield },
                ...
                <div className="space-y-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                      ...
                      <div className="mt-2 text-xs text-green-600">
                        +{getStatsForPeriod('month')} ce mois
                      </div>
                    </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                      ...
                      <div className="mt-2 text-xs text-blue-600">
                        +{getStatsForPeriod('today')} aujourd'hui
                      </div>
                    </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-2xl font-light text-gray-900 dark:text-white">
                            {users.length > 0 ? ((users.length / 1000) * 100).toFixed(1) : 0}%
                          </p>
                        </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Leads qualifiés</p>
                          <p className="text-2xl font-light text-gray-900 dark:text-white">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <button
                      ...
                      className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 text-left hover:shadow-md transition-shadow"
                    >
                      ...
                      <p className="text-gray-600 dark:text-gray-400 text-sm">
                        Voir et exporter la liste des inscrits
                      </p>
                    </button>
                    ...
                    >
                      ...
                      <p className="text-gray-600 dark:text-gray-400 text-sm">
                        Ajouter et modifier vos propriétés
                      </p>
                    </button>
                    ...
                    <button
                      ...
                      className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 text-left hover:shadow-md transition-shadow"
                    >
                      <Type className="w-8 h-8 text-purple-600 mb-4" />
                      <h4 className="text-lg font-medium text-gray-900 dark:text-white mb-2">
                        Modifier le contenu
                      </h4>
                      <p className="text-gray-600 dark:text-gray-400 text-sm">
                        Personnaliser les textes du site
                      </p>
                    </button>
                  </div>
                </div>

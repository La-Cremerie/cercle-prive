      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 relative">
            ...
            <div className="hidden lg:block absolute left-1/2 top-0 bottom-0 w-px bg-amber-500/30 transform -translate-x-1/2"></div>
            
            {/* Left Column - Avantages pour le vendeur */}
            <div className="space-y-8">
              <h4 className="text-xl sm:text-2xl font-light text-amber-500 mb-8 tracking-wide">

...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="py-12 lg:py-16 relative overflow-hidden" style={{ backgroundColor: '#0A1628' }}>
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-slate-900/30 via-transparent to-blue-900/40"></div>
      
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 relative z-10">
          <h2 className="text-3xl lg:text-4xl font-light text-white mb-3 tracking-wide">
            CONTACTEZ-NOUS
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start relative z-10">
          ...
          <div className="space-y-8">
            <div className="bg-white/5 backdrop-blur-xl rounded-2xl p-6 border border-white/10 shadow-2xl hover:bg-white/8 transition-all duration-500 group">
              <MapPin className="w-8 h-8 text-amber-400 mb-4" />
              <h3 className="text-lg font-light text-white mb-2 tracking-wide">Localisation</h3>
              <div className="w-10 h-px bg-amber-400/50 mb-3"></div>
              <p className="text-blue-100 font-light">Côte d'Azur, France</p>
              <p className="text-blue-200/70 text-sm mt-1 font-light">Riviera française d'exception</p>
            </div>

            <div className="bg-white/5 backdrop-blur-xl rounded-2xl p-6 border border-white/10 shadow-2xl hover:bg-white/8 transition-all duration-500 group">
              <Phone className="w-8 h-8 text-amber-400 mb-4" />
              <h3 className="text-lg font-light text-white mb-2 tracking-wide">Téléphone</h3>
              <div className="w-10 h-px bg-amber-400/50 mb-3"></div>
              <a href="tel:+33652913556" className="text-blue-100 hover:text-white transition-colors">
                +33 6 52 91 35 56
              </a>
              <p className="text-blue-200/70 text-sm mt-1 font-light">Disponible 7j/7 pour vos projets d'exception</p>
            </div>

            <div className="bg-white/5 backdrop-blur-xl rounded-2xl p-6 border border-white/10 shadow-2xl hover:bg-white/8 transition-all duration-500 group">
              <Mail className="w-8 h-8 text-amber-400 mb-4" />
              <h3 className="text-lg font-light text-white mb-2 tracking-wide">Email</h3>
              <div className="w-10 h-px bg-amber-400/50 mb-3"></div>
              <a href="mailto:nicolas.c@lacremerie.fr" className="text-blue-100 hover:text-white transition-colors">
                nicolas.c@lacremerie.fr
              </a>
              <p className="text-blue-200/70 text-sm mt-1 font-light">Réponse garantie sous 24h</p>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg focus:ring-2 focus:ring-amber-400 focus:border-amber-400/50 text-white placeholder-blue-200/70 transition-all duration-300 hover:bg-white/15 focus:bg-white/15"
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  rows={4}
                  className="w-full px-4 py-3 bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg focus:ring-2 focus:ring-amber-400 focus:border-amber-400/50 text-white placeholder-blue-200/70 transition-all duration-300 hover:bg-white/15 focus:bg-white/15 resize-none"
              ...
              <button
                ...
                className="w-full flex items-center justify-center space-x-3 bg-gradient-to-r from-amber-500 via-amber-600 to-amber-500 text-white py-3 px-6 rounded-lg hover:from-amber-600 hover:via-amber-700 hover:to-amber-600 focus:ring-2 focus:ring-amber-400 focus:ring-offset-2 focus:ring-offset-slate-900 transition-all duration-300 font-light tracking-wide shadow-xl hover:shadow-2xl transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
              >

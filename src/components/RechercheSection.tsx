  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      try {
        ...
        const emailSent = await EmailService.sendSearchNotification(formData);
        
        if (emailSent) {
          console.log('✅ Email de recherche envoyé avec succès');
        } else {
          console.warn('⚠️ Problème envoi email de recherche');
